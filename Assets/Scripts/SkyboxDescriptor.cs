...
[CreateAssetMenu(menuName = "Vriend/New Skybox Descriptor", order = -100, fileName = "New Skybox Descriptor")]
public class SkyboxDescriptor : ScriptableObject
{
    ...
    [Tooltip("Rotation to align the sun in the video or texture with the Directional Light in the scene")]
